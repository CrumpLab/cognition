...
Each week class time will involve a lecture and other class activities. Readings corresponding to chapters in the textbook, and occasionally primary research articles will be assigned each week. The schedule of lectures, with links to the readings, quizzes and exams is listed in the table below. 
