...
There are multiple paths for students to engage with course materials and achieve their desired grade. **All assignments are conducted and/or submitted via blackboard by the due dates set on blackboard**.
...
Students can complete as many quizzes or assignments as they want, for a maximum of 60 points toward their final grade. Any points over 60 count toward extra-credit (see extra credit-section).
