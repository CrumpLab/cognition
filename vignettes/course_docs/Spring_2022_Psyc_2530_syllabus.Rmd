...
**ENGAGE**: Each module will include assignments for students to actively engage with course material. Assignments for each module will vary, and there will be some flexibility for students to choose the assignments they complete. Weekly assignment options will include a quiz and/or a writing assignment(s).
