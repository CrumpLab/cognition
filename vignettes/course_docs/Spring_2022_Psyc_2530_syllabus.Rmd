...
**ENGAGE**: Each module will include assignments for students to actively engage with course material. Assignments for each module will vary, and there will be some flexibility for students to choose the assignments they complete. Weekly assignment options will typically include a quiz and/or a writing assignment.
...
There are multiple paths for students to engage with course materials and achieve their desired grade. All assignments are conducted or submitted via blackboard.
...
Students can complete as many assignments as they want, for a maximum of 70 points toward their final grade. However, there are opportunities for extra-credit (see extra credit-section).

There are two midterms and a final exam. All exams are worth 10 points each, for a total of 30 points toward the final grade. The exam format will be similar to the quizzes. **Taking the quizzes is practice for the exams**. The exams are NOT cumulative. Each exam covers the material from the preceding weeks.
...
It will be possible to gain additional extra credit toward your final grade. The maximum number of extra credits is 15 points, so it is hypothetically possibly to obtain a grade of 115% (A+) in this course.

Once you have reached 70 points worth of assignments, you can start earning extra-credit points by completing additional assignments. Any additional assignment that you complete will be added to your total points using a 5 to 1 formula:
...
The table below shows an example of how a student's grade would be calculated. In the example, the student completes quizzes or assignments (or both) for all 12 modules, earning a total of 80 assignment points. They receive the maximum of 70 assignment points toward their grade. The remaining 10 points are converted to extra credit (10/5 = 2 extra credit points). The student completes all three exams scoring a total of 24 points. The total is 70+2+24 = 96 points, which translates to a grade of A in the course.

| Assignment |  Points| Notes|
|:----------|--------:|-------:|
| Module 1 | 4 | quiz 1|
| Module 2 | 10 | quiz and assignment|
| Module 3 | 3 | quiz|
| Module 4 | 10 | quiz|
| Module 5 | 5 | quiz|
| Module 6 | 3 | quiz |
| Module 7 | 5 | quiz |
| Module 8 | 5 | quiz|
| Module 9 | 10 | quiz and assignment|
| Module 10 | 5 | quiz |
| Module 11 | 10 |quiz and assignment |
| Module 12 | 10 | quiz and assignment|
|Total Assignment Points| 80 | max 70|
| Extra credit | 2 | 80-70 = 10/5 = 2|
| Midterm 1 | 8 | |
| Midterm 2 | 7 | |
| Final Exam | 9  ||
| Total Exams| 24| 8+7+9|
| Total Points| 96 | 70+2+24 = 96|
| Letter Grade| A| 93.33 - 96.66|
