...
```{r predictScanning, fig.cap="Hypothetical results of the mental scanning task for the no-time, random-time, and distance-time hypotheses"}
library(ggplot2)
