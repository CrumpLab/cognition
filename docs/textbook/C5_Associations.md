...
Regular Sentence: The candy at the store was red and very tasty
Scrambled Sentence: very at red and The tasty the was store candy
...
Letters in words (faster to read letters): very at red and The tasty the was store candy
Scrambled letters (slower to read letters): tyshenoactaereadtarrdthdesetyvTwnasy
...
Before proceeding to describe his new experiments, Pavlov connected his work to philosophical ideas about humans and animals popularized much earlier by [René Descartes](https://en.wikipedia.org/wiki/René_Descartes) (1596-1650). Descartes was a rationalist philosopher who argued in favor of a dualist perspective on the mind. Humans had both a physical body that operated like a physical machine, and obeyed the laws and principles of physical machines. But, humans also had a soul, which somehow transcends the body, doesn't necessarily operate according to physical laws, and allows people to experience emotion and pain. Animals were viewed as less than human. They had physical bodies, but no soul. Although Descartes advocated for dualism, his ideas about how human and animal bodies behaved like complicated machines were inspirational to physiologists [@fearingReneDescartesStudy1929]. 

One of Descartes core ideas was the concept of a reflex, which is involves a clear-cut line of cause and effect between an impending stimulus or impulse, and a subsequent effect. For example, consider a kitchen sink, where twisting a handle opens a valve that let's water pour through the faucet ^[Descartes was apparently inspired by the complicated system of pipes in the royal gardens, hence the plumbing example]. This behavior of the sink machine is like a pre-determined reflex, the action of the impending stimulus (turning the handle) causes the response (water pouring out). A more familiar example is the [knee-jerk reflex](https://en.wikipedia.org/wiki/Patellar_reflex), where tapping a knee in the right spot can cause cause a leg to automatically kick up a little bit. Pavlov considered the possibility that the brain could be an extremely complicated system of reflexes, with many input pathways connected to output pathways. Of Descartes idea he wrote, 
