...
\includegraphics[width=1\linewidth]{imgs/learning_module_icons}

\end{floatrightbox25}

\hypertarget{learning-module}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L1_What_is_cognition.html}{Learning module}}{Learning module}}\label{learning-module}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L1_What_is_cognition.html}{Learning module}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L1_What_is_cognition.html}{learning module page} for video lectures, slide-decks and assignments.
...
What is \protect\hyperlink{gls-cognition}{cognition} and how does it work? The book is titled ``Instances of Cognition'' to alert you to the diversity of ideas, approaches, and interests in cognition. We will also learn later that there are instance theories of cognition.\footnote{\protect\hyperlink{ref-jamiesonInstanceTheoryDomaingeneral2022}{Jamieson, R. K., Johns, B. T., Vokey, J. R., \& Jones, M. N. (2022). Instance theory as a domain-general framework for cognitive psychology. \emph{Nature Reviews Psychology}. \url{https://doi.org/gpd7zt}}, readcube link to read the paper online \url{https://rdcu.be/cGGzW}.} So, although research into cognition has been ongoing across centuries and much knowledge has been generated, there are many perspectives and unresolved issues that prevent widely agreed upon answers to questions about what cognition is and how it works.
...
\begin{quote}
``If X is an interesting or socially important aspect of memory, then psychologists have hardly ever studied X''.\footnote{\protect\hyperlink{ref-RememberingFatherCognitive2012}{Remembering the {Father} of {Cognitive Psychology}. (2012). \emph{APS Observer}, \emph{25}(5)}.}
\end{quote}
...
The first step is to find a primary research article to read. To demonstrate QALMRI, I chose a paper from my own research. The article is titled, ``Warning: this keyboard will deconstruct -- The role of the keyboard in skilled typewriting.''\footnote{\protect\hyperlink{ref-Crump_2010:2}{Crump, M. J. C., \& Logan, G. D. (2010). Warning: {This} keyboard will deconstruct\textemdash{} {The} role of the keyboard in skilled typewriting. \emph{Psychonomic Bulletin \& Review}, \emph{17}(3), 394--399. \url{https://doi.org/d9jmzm}}.} This paper was published in the journal Psychonomic Bulletin and Review in 2010 and can be \href{https://link.springer.com/article/10.3758/PBR.17.3.394}{freely downloaded as a pdf here}.
...
\hypertarget{learning-module-1}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L2_Mental_imagery.html}{Learning module}}{Learning module}}\label{learning-module-1}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L2_Mental_imagery.html}{Learning module}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L2_Mental_imagery.html}{learning module page} for video lectures, slide-decks and assignments.

\hypertarget{chapter-overview-1}{%
\section{Chapter Overview}\label{chapter-overview-1}}

This chapter discusses historical and current research on \protect\hyperlink{gls-mentalimagery}{mental imagery}. Overarching questions include: What is mental imagery and how does it work? What kind of explanation would answer this question? How did prior researchers tackle these questions, and what has been learned about mental imagery? And, how has society been influenced by research into mental imagery? Two major topics include individual differences in mental imagery and the mental imagery debate.
...
During the encoding phase, the experimenter read lists of 16 word pairs out loud, with a two second pause in between. Half of the word pairs had a concrete noun, and the other half had an abstract noun. During the memory test, the experimenter read out only the first word from each pair (the adjective), and participants were asked to remember the word it was paired with and write it down. If you heard the word \emph{Amazing} and you were given the concrete pair, then the correct answer would be to write down \emph{Circus}. If you were given the abstract pair, then the correct answer would be \emph{Crusade}.
...
\hypertarget{learning-module-2}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L3_Eugenics_IQ.html}{Learning module}}{Learning module}}\label{learning-module-2}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L3_Eugenics_IQ.html}{Learning module}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L3_Eugenics_IQ.html}{learning module page} for video lectures, slide-decks and assignments.
...
By 1882, fear of undesirables spread to American immigration policy, and immigrants who were found to be ``undesirable'' could be denied entry to the USA.\footnote{\protect\hyperlink{ref-bayntonDefectivesLandDisability2005}{Baynton, D. C. (2005). Defectives in the land: {Disability} and {American} immigration policy, 1882-1924. \emph{Journal of American Ethnic History}, \emph{24}(3), 31--44}; \protect\hyperlink{ref-chenFitCitizenshipEugenics2015}{Chen, M. (2015). Fit for {Citizenship}?: {The Eugenics Movement} and {Immigration Policy}. \emph{Dissent}, \emph{62}(2), 73--86. \url{https://doi.org/gmqz7d}}.} By 1897, fear that ``degenerates'' would reproduce and overwhelm society led lawmakers in Michigan to propose a compulsory sterilization law--where the state would forcibly sterilize any woman deemed to be a degenerate. Compulsory sterilization laws were adopted by over 30 states and led to 60,000 forced sterilizations.\footnote{\protect\hyperlink{ref-EugenicsCompulsorySterilization}{\emph{Eugenics: {Compulsory Sterilization} in 50 {American States}}. (n.d.). https://www.uvm.edu/\textasciitilde lkaelber/eugenics/}.} By the early 1900s, the formal eugenics societies were being established around the world.

In Britain, Galton sat as the first president of the Eugenics Education Society in 1907. One year earlier, Charles Davenport formed a Eugenics committee in the American breeders association-- a pre-cursor to the Eugenics Record Office, which was the national headquarters of eugenics in the USA (located at Cold Springs Harbor Laboratory in Huntington, Long Island, NY).\footnote{\protect\hyperlink{ref-allenEugenicsRecordOffice1986}{Allen, G. E. (1986). The eugenics record office at {Cold Spring Harbor}, 1910-1940: An essay in institutional history. \emph{Osiris}, \emph{2}, 225--264. \url{https://doi.org/fqthgg}}.} Eugenics societies spread across the world. The Oxford handbook of the history of eugenics,\footnote{\protect\hyperlink{ref-bashfordOxfordHandbookHistory2010}{{``The {Oxford Handbook} of the {History} of {Eugenics},''} 2010}.} has individual chapters describing the aftermath of eugenics in Britain, South Asia, Australia and New Zealand, China and Hong Kong, South Africa, Colonial Kenya, Germany, France, the Netherlands and the Dutch East Indies, the Scandinavian States, Southern Europe, Eastern Europe, Russia and the Soviet Union, Japan, Iran, the Jewish Diaspora; Cuba Puerto, Rico, and Mexico; Brazil, the United States, and Canada.
...
The numerous Nazi war atrocities which were clearly driven by and connected to the German eugenics movement are commonly cited as a reason for the world-wide decline of the eugenics movement after world war II. In America, the previously very public eugenics movement became unpopular. Eugenics journals changed their names. Eugenics societies stopped publishing their member lists. The damaging legacy and history of eugenics movements continues to the present day, and additional coverage is beyond the scope of this chapter. For further reading on this topic consider these books.\footnote{\protect\hyperlink{ref-kuhlBettermentRaceRise2013}{Kühl, 2013}; \protect\hyperlink{ref-bashfordOxfordHandbookHistory2010}{{``The {Oxford Handbook} of the {History} of {Eugenics},''} 2010}; \protect\hyperlink{ref-wilsonEugenicThinking2018}{Wilson, R. A. (2018). Eugenic {Thinking}. \emph{Philosophy, Theory, and Practice in Biology}, \emph{10}(20200624). \url{https://doi.org/gg386w}}.}
...
Kamin, L. J. (1974). \emph{The Science and Politics of IQ}. Psychology Press.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

Kühl, S. (2013). \emph{For the Betterment of the Race - The Rise and Fall of
...
Selden, S. (1999). \emph{Inheriting Shame: The Story of Eugenics and Racism
in America}. Teachers College Press.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\emph{The Eugenics Archives}. \url{https://eugenicsarchive.ca/}.
...
P. Levine (Eds.), \emph{The Oxford Handbook of the History of Eugenics}.
Oxford University Press.
\url{https://doi.org/10.1093/oxfordhb/9780195373141.001.0001}

A comprehensive resource.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

Tucker, W. H. (2002). \emph{The Funding of Scientific Racism: Wickliffe
...
Psychologists: Early Formation and Development. \emph{Journal of Black
Psychology}, \emph{1}(1), 9--24. \url{https://doi.org/gg3hq4}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

Wilson, R. A. (2017). \emph{The Eugenic Mind Project}. MIT Press.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

Yakushko, O. (2019). Eugenics and its evolution in the history of western psychology: A critical archival review. \emph{Psychotherapy and Politics International}, \emph{17}. \url{https://doi.org/10/gg3hsf}

Yakushko, O. (2019). \emph{Scientific Pollyannaism: From Inquisition to
Positive Psychology}. Springer International Publishing.
\url{https://doi.org/10.1007/978-3-030-15982-5}
...
Word Count & Reading Time & Last Compiled\\
\hline
6691 & 33.5 minutes & 2022-04-22 14:26:07 GMT\\
\hline
\end{tabular}
...
\hypertarget{learning-module-3}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L3_Eugenics_IQ.html}{Learning module}}{Learning module}}\label{learning-module-3}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L3_Eugenics_IQ.html}{Learning module}}
...
\hypertarget{learning-module-4}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L4_Associations.html}{Learning module}}{Learning module}}\label{learning-module-4}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L4_Associations.html}{Learning module}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L4_Associations.html}{learning module page} for video lectures, slide-decks and assignments.
...
The experiments of Thorndike and Pavlov are also set in a background of philosophy, especially debates in \href{https://en.wikipedia.org/wiki/Epistemology}{epistemology} between \href{https://plato.stanford.edu/entries/rationalism-empiricism/}{rationalist and empiricist views of knowledge}.
...
\hypertarget{learning-module-5}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L5_Behaviorism.html}{Learning module}}{Learning module}}\label{learning-module-5}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L5_Behaviorism.html}{Learning module}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L5_Behaviorism.html}{learning module page} for video lectures, slide-decks and assignments.
...
Pavlov's methods and findings arrived in America at the same time that psychologists were trying to establish themselves as real scientists. Psychologists were already investigating associative processes in animal cognition (e.g., Thorndike), and humans using reaction times (e.g., Cattell). And, perhaps the physiological nature of Pavlov's methods appeared attractive as a ``more scientific'' way to measure associative learning. It is certainly the case that Pavlovian conditioning was inspirational to \href{https://en.wikipedia.org/wiki/John_B._Watson}{John B. Watson} (1878-1958), the ``arch-prophet'' \footnote{according to Tolman} of Behaviorism. As we will cover shortly, Watson's behaviorism consisted of grand claims that psychology should become a science of stimulus-response learning.
...
\hypertarget{learning-module-6}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L6_Information_processing.html}{Learning module}}{Learning module}}\label{learning-module-6}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L6_Information_processing.html}{Learning module}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L6_Information_processing.html}{learning module page} for video lectures, slide-decks and assignments.
...
\hypertarget{learning-module-7}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L7_Memory_I.html}{Learning module}}{Learning module}}\label{learning-module-7}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L7_Memory_I.html}{Learning module}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L7_Memory_I.html}{learning module page} for video lectures, slide-decks and assignments.
...
\hline
1 & SIJ & SIG & BEH & QEL & WUB & MUW & JUW & VAJ & FAF & NOV & YUX & QEL & YUN\\
\hline
2 & JOQ & RUD & TUL & REK & KUQ & WIM & RON & YUB & WUB & WOD & SID & MUV & ZID\\
\hline
3 & PIF & XIZ & ZEV & TIZ & SOZ & VOK & COH & CIL & LUH & ZAY & XUG & WOD & QOH\\
\hline
4 & YUV & DUR & XOL & KIJ & BIX & TOC & QIH & XUC & XIM & BEW & SAH & JUY & QOG\\
\hline
5 & KAC & QAP & WIV & DUM & CAX & QIV & CEN & TIY & KOX & NUD & ZUN & LIQ & QUB\\
\hline
6 & MEB & MUX & PUH & SEK & XIT & SAV & TIW & PAG & POS & XAQ & XAZ & BUW & FUM\\
\hline
7 & NEK & NUJ & MAV & BUF & GUS & REH & RIQ & MAH & JUP & MEH & HEK & LIX & ZAB\\
\hline
8 & JID & RER & HEF & XUJ & GAX & ZIF & KIK & VUD & VON & FAF & DEQ & MAF & PEV\\
\hline
\end{tabular}
\endgroup{}
\end{table}
...
\includegraphics[width=1\linewidth]{C8_Memory_I_files/figure-latex/unnamed-chunk-6-1}
...
\hypertarget{learning-module-8}{%
\section*{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L8_Memory_II.html}{Learning module}}{Learning module}}\label{learning-module-8}}
\addcontentsline{toc}{section}{\href{https://www.crumplab.com/cognition/articles/modules/L8_Memory_II.html}{Learning module}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L8_Memory_II.html}{learning module page} for video lectures, slide-decks and assignments.
...
\includegraphics[width=1\linewidth]{C9_Memory_II_files/figure-latex/unnamed-chunk-8-1}
...
\hypertarget{learning-module-9}{%
\section{\texorpdfstring{\href{https://www.crumplab.com/cognition/articles/modules/L10_Attention.html}{Learning module}}{Learning module}}\label{learning-module-9}}

See the \href{https://www.crumplab.com/cognition/articles/modules/L10_Attention.html}{learning module page} for video lectures, slide-decks and assignments.
...
CATTELL, J. McK. (1890). V.\textemdash{{MENTAL TESTS AND MEASUREMENTS}} \emph{Mind}, \emph{os-XV}(59), 373--381. \url{https://doi.org/dhn9nc}
...
Crump, M. J. C., \& Logan, G. D. (2010). Warning: {This} keyboard will deconstruct\textemdash{} {The} role of the keyboard in skilled typewriting. \emph{Psychonomic Bulletin \& Review}, \emph{17}(3), 394--399. \url{https://doi.org/d9jmzm}

\leavevmode\vadjust pre{\hypertarget{ref-DanielTammet2021}{}}%
Daniel {Tammet}. (2021). \emph{Wikipedia}.
...
Donders, F. C. (1868). On the speed of mental processes. In W. G. Koster (Ed.), \emph{Attention and {Performance II}}. {North-Holland Publishing Company}.
...
Dowbiggin, I. R. (1997). \emph{Keeping {America Sane}: {Psychiatry} and {Eugenics} in the {United States} and {Canada}, 1880-1940}. {Cornell University Press}.
...
\emph{Eugenics: {Compulsory Sterilization} in 50 {American States}}. (n.d.). https://www.uvm.edu/\textasciitilde lkaelber/eugenics/.
...
Gilbert, J. A. (1895). {THE MENTAL AND PHYSICAL DEVELOPMENT OF SCHOOL CHILDREN}.\textemdash ({I}). \emph{The Journal of Education}, \emph{42}(17 (1050), 291--292.
...
Hintzman, D. L. (1969). Recognition time: {Effects} of recency, frequency and the spacing of repetitions. \emph{Journal of Experimental Psychology}, \emph{79}(1, Pt.1), 192--194. \url{https://doi.org/ff46mx}
...
\leavevmode\vadjust pre{\hypertarget{ref-jamiesonInstanceTheoryDomaingeneral2022}{}}%
Jamieson, R. K., Johns, B. T., Vokey, J. R., \& Jones, M. N. (2022). Instance theory as a domain-general framework for cognitive psychology. \emph{Nature Reviews Psychology}. \url{https://doi.org/gpd7zt}
...
Johnson, A. M. (2021). Opinion \textbar{} {I}'m the {Head} of {Planned Parenthood}. {We}'re {Done Making Excuses} for {Our Founder}. \emph{The New York Times}.
...
Kühl, S. (2013). \emph{For the {Betterment} of the {Race} - {The Rise} and {Fall} of the {International Movement} for {Eugenics} and {Racial Hygiene}}. {Palgrave Macmillan}.
...
Nicolas, S., Coubart, A., \& Lubart, T. (2014). The program of individual psychology (1895-1896) by {Alfred Binet} and {Victor Henri}. \emph{LAnnee Psychologique}, \emph{Vol. 114}(1), 5--60.
...
Pavlov, I. P. (1927). \emph{Conditioned reflexes: {An} investigation of the physiological activity of the cerebral cortex} (A. G. V., Ed.). {London: Oxford University Press}.
...
Remembering the {Father} of {Cognitive Psychology}. (2012). \emph{APS Observer}, \emph{25}(5).
...
Roediger III, H. L., \& Craik, F. I. (1987). \emph{Paul {A}. {Kolers} (1926\textendash 1986).} \url{https://doi.org/dx7dcm}
...
Shannon, Claude E., \& Weaver, W. (1949). \emph{The mathematical theory of communication}. {University of Illinois press}.
...
Terman, L. M. (1916). \emph{The {Measurement} of intelligence: {An} explanation of and complete guide for the use of the stanford revision and extension of the {Binet-Simon Intelligence Scale}}. {Houghton Mifflin}.

\leavevmode\vadjust pre{\hypertarget{ref-bashfordOxfordHandbookHistory2010}{}}%
The {Oxford Handbook} of the {History} of {Eugenics}. (2010). In A. Bashford \& P. Levine (Eds.), \emph{The Oxford Handbook of the History of Eugenics}. {Oxford University Press}. \url{https://doi.org/10.1093/oxfordhb/9780195373141.001.0001}
...
Umpleby, S. (2008). Definitions of cybernetics. \emph{The Larry Richards Reader 1997\textendash 2007}, 9--11.
...
Welford, Alan T. (1952). The `psychological refractory period'and the timing of high-speed performance\textemdash a review and a theory. \emph{British Journal of Psychology. General Section}, \emph{43}(1), 2--19. \url{https://doi.org/c7jfrb}
...
Zeman, A., Milton, F., Della Sala, S., Dewar, M., Frayling, T., Gaddum, J., Hattersley, A., Heuerman-Williamson, B., Jones, K., \& MacKisack, M. (2020). Phantasia\textendash the psychological significance of lifelong visual imagery vividness extremes. \emph{Cortex}, \emph{130}, 426--440. \url{https://doi.org/ghdxvf}

\leavevmode\vadjust pre{\hypertarget{ref-zimmerManyPeopleHave2021}{}}%
Zimmer, C. (2021). Many {People Have} a {Vivid} {``{Mind}'s {Eye},''} {While Others Have None} at {All}. \emph{The New York Times}.
