...
<span class = "greyed_box"> Recall Task </span>
...
<span class = "greyed_box"> Recognition Task </span>
...
These are experimental manipulations known influence memory
...
We will review experimental findings showing that some manipulation changes performance in a memory task

Example:

>- Ebbinghaus **manipulated** the delay between learning and re-learning lists of nonsense syllables
>- He showed the **phenomena** of forgetting by measuring changes in re-learning rates across delays

# Many Memory Phenomena

The textbook reviews several phenomena
...
Do you remember more frequent things better then infrequent things?
...
>- phase 1: learn 24 nonsense syllables and memory test
>- GROUP A phase 2: learn 24 new nonsense syllabes
>- GROUP B phase 2: read magazine
