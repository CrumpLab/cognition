...
Memory phenomena are experimental findings showing that some manipulation changes performance in a memory task
...
The textbook reviews several examples of manipulations that are known to influence memory performance, let's review some of them
